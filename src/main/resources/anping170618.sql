...
-- ----------------------------
-- Table structure for service_tel_call_history
-- ----------------------------
DROP TABLE IF EXISTS `service_tel_call_history`;
CREATE TABLE `service_tel_call_history` (
...
-- ----------------------------
-- Records of service_tel_call_history
-- ----------------------------
INSERT INTO `service_tel_call_history` VALUES ('1', '', '15933855081', '2017-06-18 22:25:36');